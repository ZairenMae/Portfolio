...
# Page configuration
st.set_page_config(
    page_title="Zairen Mae A. Niñofranco - Autobiography & Portfolio",
    page_icon="👤",
    layout="wide",
)

# Load the background image
background_image_path = "E:/4th yr/CSIT342/Basic Streamlit App/Enchanted Workshop At Night With Glowing Crystal Cube.png"
b64_background = encode_image(background_image_path)

# Load the profile image
profile_image_path = "E:/4th yr/CSIT342/Basic Streamlit App/zairen.jpg"
profile_b64_string = encode_image(profile_image_path)

# Icons
icons_paths = [
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/android.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/artificial-intelligence.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/css.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/html-5.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/java.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/js.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/nextjs.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/nodejs.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/python.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/react2.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/springboot2.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/streamlit.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/typescript.png",
    "E:/4th yr/CSIT342/Basic Streamlit App/icons/vite-js2.png"
]
...
.title {{ 
    ...
    text-align: center;
    margin-bottom: 0px;
    margin-top: -250px; /* Move name upwards closer to black square */
    color: white;
}}
.subtitle {{
    font-size: 1.5em;
...
.profile-image {{
    ...
    border-radius: 50%;
    margin-bottom: -10px; /* Remove space between image and name */
}}
...
st.markdown(f"<img src='data:image/jpeg;base64,{profile_b64_string}' class='profile-image' />", unsafe_allow_html=True)
st.markdown("<h1 class='title'>Zairen Mae A. Niñofranco</h1>", unsafe_allow_html=True)
...
st.markdown("<h2 class='subtitle'>BSIT Student | Aspiring Full-Stack Developer</h2></div>", unsafe_allow_html=True)
