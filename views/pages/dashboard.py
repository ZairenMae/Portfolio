...
# Paths to images
bg_img_path = 'views/images/Abandoned Mansion With Grand Staircase And Ethereal Lighting.png'
center_img_path = 'views/images/2b.png'

icon_paths = [
    'views/images/about.png',
    'views/images/facebook.png',
    'views/images/github.png',
    'views/images/instagram.png',
    'views/images/linkedin.png',
    'views/images/projects.png',
]
